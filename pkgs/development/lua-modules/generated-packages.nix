...
cript.org";
  ...
  zipwriter = callPackage (
    ...
    buildLuarocksPackage {
      ...
      knownRockspec =
        (fetchurl {
          url = "mirror://luarocks/zipwriter-0.1.5-1.rockspec";
          sha256 = "0d86fyxz5nyijv9002vv1d41h4rlw9lwji1ymk0yv936dc77hw1a";
        }).outPath;
      src = fetchzip {
        url = "https://github.com/moteus/ZipWriter/archive/v0.1.5.zip";
        sha256 = "0rja2hpsf6iczhidywmvsrbgrmdqdx4nb7zszdlfpk07fxcpvizw";
      };
      ...
      meta = {
        ...
        description = "Library for creating ZIP archive for Lua";
        license.fullName = "MIT/X11";
      };
    }
  ) { };
